    ...
    <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
      ...
      <FormControl sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
        ...
        <Button
          ...
          sx={{ fontWeight: 'bold', bgcolor: '#052566', }}
        >
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Tab sx={{ fontWeight: 'bold' , color: '#052566' }}label='Login' {...a11yProps(0)} />
          <Tab sx={{ fontWeight: 'bold', color: '#052566', }} label='Register' {...a11yProps(1)} />
        </Tabs>
      </Box>
      <div style={{ width: '100%' }}>
